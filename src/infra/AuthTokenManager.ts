...
export class AuthTokenManager {
     ...
     */
    static isValidAccessToken(accessToken : string) {
        try {
     ...
     */
    static buildRefreshToken(payload: any) {
        return jwt.sign(
            {
                user: {
                    id: payload.userId,
    ...
    static isValidRefreshToken(refreshToken: string) {
        try {
     ...
     */
    static getRequesterFromToken(authorizationHeaderValue: any) {
    ...
    static getRequesterFromTokenOrDefault(authorizationHeaderValue: string) {
        try {
