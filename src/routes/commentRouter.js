...
// 댓글 생성 (인증 필요)
commentRouter.post('/:itemType/:itemId', auth.verifyAccessToken, commentController.createComment);
...
// 특정 댓글 수정 (인증 필요)
commentRouter.patch('/:commentId', auth.verifyAccessToken, commentController.updateComment);
