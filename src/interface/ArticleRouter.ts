...
ArticleRouter.post(
    '/',
    AuthN(),
    asyncErrorHandler(async (req:Request<{}, {}, TArticle>, res:Response) => {
...
ArticleRouter.get(
    '/:articleId',
    asyncErrorHandler(async (req: Request< {articleId: number} >, res: Response) => {
...
ArticleRouter.patch(
    '/:articleId',
    AuthN(),
    asyncErrorHandler(async (req:Request< {articleId: TArticle;} >, res: Response) => {
        const requester = AuthTokenManager.getRequesterFromToken(req.headers.authorization);
...
ArticleRouter.get(
    '/',
    asyncErrorHandler(async (req:Request< {}, {}, {}, ArticleRouterQuery >, res: Response) => {
        const requester = AuthTokenManager.getRequesterFromTokenOrDefault(
            req.headers.authorization!,
        );
...
ArticleRouter.post(
    '/:articleId/comments',
    AuthN(),
    asyncErrorHandler(async (req:Request< {articleId: number}, {}, {content: string}>, res:Response) => {
        const requester = AuthTokenManager.getRequesterFromToken(req.headers.authorization);
...
ArticleRouter.get(
    '/:articleId/comments',
    asyncErrorHandler(async (req: Request<{articleId: number}, {}, {}, ArticleRouterQuery>, res: Response) => {
        const { articleId } = req.params;
