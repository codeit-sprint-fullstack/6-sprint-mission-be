...
AuthRouter.post(
    '/signUp',
    asyncErrorHandler(async (req : Request<{}, {}, AuthRouterRequest>, res: Response) => {
...
AuthRouter.post(
    '/signIn',
    asyncErrorHandler(async (req : Request<{}, {}, Pick<User, "email" | "password">>, res: Response) => {
...
AuthRouter.post(
    '/refresh-token',
    asyncErrorHandler(async (req : Request<{},{},{refreshToken: string;}>, res: Response) => {
...
// AuthRouter.get(
//     '/google/callback',
//     asyncErrorHandler(async (req : Request<{code: string | undefined}>, res: Response) => {
