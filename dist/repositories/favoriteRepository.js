...
function addFavorite(productId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_prisma_js_1.default.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
...
function isProductLikedByUser(productId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const favorite = yield client_prisma_js_1.default.favorite.findUnique({
