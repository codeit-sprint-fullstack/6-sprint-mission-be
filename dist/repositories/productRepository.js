...
function save(product) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_prisma_1.default.product.create({
            data: {
                name: product.name,
...
function getById(productId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const product = yield client_prisma_1.default.product.findUnique({
            where: { id: productId },
            include: {
                favorites: {
        ...
        if (!product)
            throw new errors_1.NotFoundError("해당 제품이 없습니다");
...
function getAll(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const products = yield client_prisma_1.default.product.findMany({
            where: {
                name: {
                    contains: keyword,
                    mode: "insensitive",
...
function update(productId, data) {
    return __awaiter(this, void 0, void 0, function* () {
        const updatedProduct = yield client_prisma_1.default.product.update({
            where: {
                id: productId,
            },
            data: {
...
function deleteById(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_prisma_1.default.product.delete({
            where: { id },
        });
    });
}
function saveProductComment(comment) {
    return __awaiter(this, void 0, void 0, function* () {
        const createdComment = yield client_prisma_1.default.comment.create({
            data: {
...
function getAllProductComment(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const productComments = yield client_prisma_1.default.comment.findMany({
            where: {
                productId: id,
            },
        });
