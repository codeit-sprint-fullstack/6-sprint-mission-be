...
function getByOptions(options) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.item.findMany(options);
    });
}
function getById(id, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const item = yield client_1.default.item.findUnique({
            where: { id },
            include: {
                comments: {
                    include: {
        ...
        const isFavorite = yield client_1.default.item.findFirst({
            where: {
                id,
                favoriteUsers: {
                    some: { id: userId },
...
function save(item) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.item.create({
            data: {
                name: item.name,
...
function edit(id, item) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.item.update({
            where: { id },
            data: {
                name: item.name,
                description: item.description,
...
function remove(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.item.delete({
            where: { id },
        });
    });
}
