...
function getByOptions(options) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.article.findMany(options);
    });
}
function getById(id, userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const article = yield client_1.default.article.findUnique({
            where: { id },
            include: {
                comments: {
                    include: {
        ...
        const isFavorite = yield client_1.default.article.findFirst({
            where: {
                id,
                favoriteUsers: {
                    some: { id: userId },
...
function save(article) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.article.create({
            data: {
                title: article.title,
...
function edit(id, article) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.article.update({
            where: { id },
            data: {
                title: article.title,
                content: article.content,
...
function remove(id) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield client_1.default.article.delete({
            where: { id },
        });
    });
}
